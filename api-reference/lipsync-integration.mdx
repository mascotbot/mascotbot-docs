...
<Note>This example server route waits for the full completion of audio, as it is a basic example. For faster text-to-playback, you can implement playback on a client as soon as the API returns the first viseme/lipsync data chunk</Note>
