...
```bash
pnpm add @mascotbot-sdk/lipsync-react @rive-app/react-webgl2 @rive-app/webgl2 @google/genai
```
...
import { useLipsync, createPCMStreamPlayer, type PCMStreamPlayer } from "@mascotbot-sdk/lipsync-react";
