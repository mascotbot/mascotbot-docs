...
object per render** — see [Rive co-existence](/concepts/rive-coexistence)).
...
This pattern is correct regardless of how often `teardown`'s identity
...
[ElevenLabs onModeChange recipe](/libraries/elevenlabs-avatar#gestures-on-every-agent-turn)
...
The whole page shares **one `<MascotProvider>` → one
