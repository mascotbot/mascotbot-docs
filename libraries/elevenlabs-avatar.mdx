...
```bash
npm install ./mascotbot-sdk-react-0.1.5.tgz @elevenlabs/react
# or
pnpm add ./mascotbot-sdk-react-0.1.5.tgz @elevenlabs/react
```
...
<Columns cols={2}>
  <Card title="GitHub Repository" icon="github" href="https://github.com/mascotbot/sdk">
