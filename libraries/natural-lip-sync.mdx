...
```tsx
import { useMascotPlayback } from "@mascotbot-sdk/lipsync-react/rive";
...
```ts
import { DEFAULT_NATURAL_LIPSYNC_CONFIG, DEFAULT_CRITICAL_VISEME_IDS } from "@mascotbot-sdk/lipsync-react/rive";
...
The processor is exported from `@mascotbot-sdk/lipsync-core/rive` as a class
and a function:

```ts
import { processNaturalLipSync, NaturalLipSyncProcessor } from "@mascotbot-sdk/lipsync-core/rive";
```
