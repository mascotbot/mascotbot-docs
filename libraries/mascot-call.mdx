...
MascotCall encapsulates the core call-handling logic. It is designed to work in tandem with [MascotClient](https://docs.mascot.bot/libraries/react-sdk) and the underlying voice client from the Pipecat platform. For a general integration of the Mascotbot React SDK, see the [Mascotbot React SDK Documentation](https://docs.mascot.bot/libraries/react-sdk).
...
For full installation and setup details, please see the [Mascotbot React SDK Docs](https://docs.mascot.bot/libraries/react-sdk).
...
For more details and advanced configuration options, consult the [Mascotbot React SDK documentation](https://docs.mascot.bot/libraries/react-sdk) and the relevant source files in the repository.
